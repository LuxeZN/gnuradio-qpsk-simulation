...
# Author: Zach Naymik
# Description: Simulated QPSK Flow over ZeroMQ
...
class qpsk_sim_with_filters(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "qpsk_sim_with_filters")
        ...
        self.constObj = constObj = digital.constellation_calcdist([-1-1j, -1+1j, 1+1j, 1-1j], [0, 1, 2, 3],
        4, 1, digital.constellation.NO_NORMALIZATION).base()
        self.constObj.set_npwr(1.0)
        self.access_key = access_key = '11100001010110101110100010010011'
        self.variable_adaptive_algorithm_0 = variable_adaptive_algorithm_0 = digital.adaptive_algorithm_cma( constObj, .0001, 4).base()
        self.samp_rate = samp_rate = 48000
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(nfilts, nfilts, 1.0/float(sps), 0.35, 11*sps*nfilts)
        self.phase_bw = phase_bw = .045
        ...
        self.tab.addTab(self.tab_widget_0, 'Tagged Stream Mux and Modulator')
        self.tab_widget_1 = Qt.QWidget()
        self.tab_layout_1 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_1)
        self.tab_grid_layout_1 = Qt.QGridLayout()
        self.tab_layout_1.addLayout(self.tab_grid_layout_1)
        self.tab.addTab(self.tab_widget_1, 'Symbol Sync')
        self.tab_widget_2 = Qt.QWidget()
        self.tab_layout_2 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_2)
        self.tab_grid_layout_2 = Qt.QGridLayout()
        self.tab_layout_2.addLayout(self.tab_grid_layout_2)
        self.tab.addTab(self.tab_widget_2, 'Costas Loop')
        self.tab_widget_3 = Qt.QWidget()
        self.tab_layout_3 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_3)
        self.tab_grid_layout_3 = Qt.QGridLayout()
        self.tab_layout_3.addLayout(self.tab_grid_layout_3)
        self.tab.addTab(self.tab_widget_3, 'Linear Equalizer')
        ...
        self.tab.addTab(self.tab_widget_4, 'Decoder Output')
        self.top_grid_layout.addWidget(self.tab, 0, 0, 3, 1)
        for r in range(0, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.zeromq_sub_source_0 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:5000', 100, False, (-1), '', False)
        ...
        self.tab_grid_layout_0.addWidget(self._qtgui_time_sink_x_0_2_win, 0, 0, 1, 3)
        for r in range(0, 1):
        ...
        self.qtgui_time_sink_x_0_0_1_0 = qtgui.time_sink_f(
            256, #size
            samp_rate, #samp_rate
            'Input to Correlate Access Code', #name
            1, #number of inputs
            None # parent
        )
        self.qtgui_time_sink_x_0_0_1_0.set_update_time(0.10)
        self.qtgui_time_sink_x_0_0_1_0.set_y_axis(-0.1, 1.1)

        self.qtgui_time_sink_x_0_0_1_0.set_y_label('Amplitude', "")

        self.qtgui_time_sink_x_0_0_1_0.enable_tags(True)
        self.qtgui_time_sink_x_0_0_1_0.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.1, 0.0, 0, "packet_len")
        ...
        self.qtgui_time_sink_x_0_0_1 = qtgui.time_sink_f(
            256, #size
            samp_rate, #samp_rate
            'Differential Decoder Output', #name
            1, #number of inputs
            None # parent
        )
        self.qtgui_time_sink_x_0_0_1.set_update_time(0.10)
        self.qtgui_time_sink_x_0_0_1.set_y_axis(-0.1, 1.1)

        self.qtgui_time_sink_x_0_0_1.set_y_label('Amplitude', "")

        self.qtgui_time_sink_x_0_0_1.enable_tags(True)
        self.qtgui_time_sink_x_0_0_1.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.1, 0.0, 0, "packet_len")
        ...
        self.tab_grid_layout_4.addWidget(self._qtgui_time_sink_x_0_0_1_win, 0, 0, 1, 1)
        for r in range(0, 1):
            self.tab_grid_layout_4.setRowStretch(r, 1)
        for c in range(0, 1):
            self.tab_grid_layout_4.setColumnStretch(c, 1)
        ...
        self.qtgui_time_sink_x_0_0 = qtgui.time_sink_f(
            256, #size
            samp_rate, #samp_rate
            'Output of Coorelate Access Code', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0_0.set_trigger_mode(qtgui.TRIG_MODE_TAG, qtgui.TRIG_SLOPE_POS, 0.1, 0.0, 0, 'corr')
        ...
        self.qtgui_const_sink_x_1 = qtgui.const_sink_c(
            1024, #size
            "Modulator Constellation Output", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.tab_grid_layout_0.addWidget(self._qtgui_const_sink_x_1_win, 1, 0, 1, 4)
        for r in range(1, 2):
            self.tab_grid_layout_0.setRowStretch(r, 1)
        for c in range(0, 4):
            self.tab_grid_layout_0.setColumnStretch(c, 1)
        self.qtgui_const_sink_x_0_0_0_0 = qtgui.const_sink_c(
            1024, #size
            "Linear Equalizer Constellation Output", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.tab_grid_layout_3.addWidget(self._qtgui_const_sink_x_0_0_0_0_win, 0, 2, 1, 1)
        for r in range(0, 1):
        ...
        self.qtgui_const_sink_x_0_0_0 = qtgui.const_sink_c(
            1024, #size
            "Costas Loop Constellation Output", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.tab_grid_layout_2.addWidget(self._qtgui_const_sink_x_0_0_0_win, 0, 2, 1, 1)
        for r in range(0, 1):
        ...
        self.qtgui_const_sink_x_0_0 = qtgui.const_sink_c(
            1024, #size
            "Symbol Sync Constellation Output", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.tab_grid_layout_1.addWidget(self._qtgui_const_sink_x_0_0_win, 0, 2, 1, 1)
        for r in range(0, 1):
        ...
        self.digital_linear_equalizer_0 = digital.linear_equalizer((int(nfilts / 2)), 1, variable_adaptive_algorithm_0, True, [ ], 'corr_est')
        self.digital_diff_decoder_bb_0 = digital.diff_decoder_bb(4, digital.DIFF_DIFFERENTIAL)
        self.digital_crc32_bb_0_0 = digital.crc32_bb(True, 'corr', True)
        ...
        self.digital_constellation_modulator_0 = digital.generic_mod(
            ...
            log=False,
            truncate=False)
        self.digital_constellation_decoder_cb_0 = digital.constellation_decoder_cb(constObj)
        ...
        self.connect((self.blocks_unpack_k_bits_bb_1, 0), (self.blocks_uchar_to_float_0_0, 0))
    ...
    def set_constObj(self, constObj):
        ...
        self.digital_constellation_decoder_cb_0.set_constellation(self.constObj)
...
def main(top_block_cls=qpsk_sim_with_filters, options=None):
